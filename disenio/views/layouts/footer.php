<footer class="bg-[#f4f8f9] border-t border-slate-200 mt-auto py-6">
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <div class="flex justify-center gap-4">
                <a href="/docs/Manual_Usuario.pdf" class="group flex items-center gap-2 px-3 py-1.5 rounded-md bg-white border border-slate-200 hover:border-blue-300 hover:shadow-sm transition-all" target="_blank">
                    <div class="p-1 rounded bg-blue-50 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    ...
                    <span class="text-xs font-medium text-slate-600 group-hover:text-blue-700">Manual Usuario</span>
                </a>
                <a href="/docs/Manual_Tecnico.pdf" class="group flex items-center gap-2 px-3 py-1.5 rounded-md bg-white border border-slate-200 hover:border-indigo-300 hover:shadow-sm transition-all" target="_blank">
                     <div class="p-1 rounded bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                    ...
                    <span class="text-xs font-medium text-slate-600 group-hover:text-indigo-700">Manual Técnico</span>
                </a>
            </div>

            <!-- Credits & Copyright -->
            <div class="text-center md:text-right text-xs text-slate-500 space-y-1">
                <p>&copy; 2026 <span class="font-semibold text-slate-700">Hospital La Divina Misericordia</span>.</p>
                <div class="flex items-center justify-center md:justify-end gap-3 text-[10px] text-slate-400">
