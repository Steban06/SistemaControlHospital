...
<nav class="flex-1 p-3 lg:p-4 space-y-1 lg:space-y-2 overflow-y-auto">
    <a href="dashboard.php" class="w-full flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-lg transition-all text-sm lg:text-base <?= $current_page == 'dashboard.php' ? $active_class : $inactive_class ?>">
    ...
    <a href="gestionbienes.php" class="w-full flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-lg transition-all text-sm lg:text-base <?= $current_page == 'gestionbienes.php' ? $active_class : $inactive_class ?>">
    ...
    <a href="report.php" class="w-full flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-lg transition-all text-sm lg:text-base <?= $current_page == 'report.php' ? $active_class : $inactive_class ?>">
