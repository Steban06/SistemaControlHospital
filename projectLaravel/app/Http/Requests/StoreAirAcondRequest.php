...
class StoreAirAcondRequest extends FormRequest
{
    ...
    {
        return [
            'numero_bn' => 'required|string|max:255|unique:aires_acondicionados,numero_bn|unique:bienes_nacionales,numero_bn',
