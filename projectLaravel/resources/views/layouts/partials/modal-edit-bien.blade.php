<div id="modalEditBien" class="fixed inset-0 z-[99999] hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" style="z-index: 99999;">
    <!-- Overlay Background -->
    ...
    <div role="dialog" id="radix-:edit-modal:" 
        ...
        <form id="formEditBien" class="py-4">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <!-- Numero BN -->
                <div class="space-y-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editNumeroBN">
                        Número de Bien Nacional (#BN) <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="editNumeroBN" name="numero_bn" required
                ...
                <!-- Nombre -->
                <div class="space-y-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editNombreBien">
                        Nombre del Bien <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="editNombreBien" name="nombre" required
                        class="flex h-10 w-full rounded-md border border-gray-300 shadow-sm bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                </div>

                <!-- Marca -->
                <div class="space-y-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editMarcaBien">
                        Marca
                    </label>
                    <input type="text" id="editMarcaBien" name="marca"
                        class="flex h-10 w-full rounded-md border border-gray-300 shadow-sm bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                </div>

                <!-- Modelo -->
                <div class="space-y-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editModeloBien">
                        Modelo
                    </label>
                    <input type="text" id="editModeloBien" name="modelo"
                        class="flex h-10 w-full rounded-md border border-gray-300 shadow-sm bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                </div>

                <!-- Serial -->
                <div class="space-y-2 lg:col-span-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editSerialBien">
                        Serial
                    </label>
                    <input type="text" id="editSerialBien" name="serial"
                        class="flex h-10 w-full rounded-md border border-gray-300 shadow-sm bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                </div>

                <!-- Ubicacion -->
                <div class="space-y-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editUbicacionBien">
                ...
                <!-- Categoria -->
                <div class="space-y-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editCategoriaBien">
                ...
                <!-- Estado -->
                <div class="space-y-2 lg:col-span-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-gray-700" for="editEstadoBien">
