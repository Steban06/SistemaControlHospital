...
<div id="viewACModal" class="fixed inset-0 z-[99999] hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" style="z-index: 99999;">
    ...
    <div role="dialog" id="viewACContent" 
        ...
        <!-- Close Button (X) -->
        <button type="button" data-modal-close class="cursor-pointer absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none p-1 hover:bg-gray-100 hover:text-red-500">
        ...
        <div class="flex-1 overflow-y-auto px-6 py-4">
                ...
                <div role="tablist" aria-orientation="horizontal" data-slot="tabs-list" class="bg-gray-100/80 text-gray-500 h-10 items-center justify-center rounded-lg p-1 grid w-full grid-cols-2 mb-6 border border-gray-100" tabindex="0" data-orientation="horizontal" style="outline: none;">
                    <button type="button" role="tab" aria-selected="true" data-state="active" id="tab-trigger-general" onclick="switchTab('general')" class="data-[state=active]:bg-white data-[state=active]:text-blue-700 data-[state=active]:font-bold data-[state=active]:shadow-sm inline-flex h-full flex-1 items-center justify-center gap-2 rounded-md transition-all focus-visible:ring-2 focus-visible:ring-blue-500/50 disabled:pointer-events-none disabled:opacity-50 text-sm font-medium hover:text-gray-700">
                    ...
                    <button type="button" role="tab" aria-selected="false" data-state="inactive" id="tab-trigger-tecnica" onclick="switchTab('tecnica')" class="data-[state=active]:bg-white data-[state=active]:text-blue-700 data-[state=active]:font-bold data-[state=active]:shadow-sm inline-flex h-full flex-1 items-center justify-center gap-2 rounded-md transition-all focus-visible:ring-2 focus-visible:ring-blue-500/50 disabled:pointer-events-none disabled:opacity-50 text-sm font-medium hover:text-gray-700">
        ...
        <div class="flex-shrink-0 px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex flex-col gap-3">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    <button id="view_btn_edit" onclick="" class="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold transition-all text-white h-10 px-4 bg-blue-600 hover:bg-blue-700 hover:shadow-md text-sm shadow-sm ring-1 ring-blue-700/10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-square-pen"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"></path></svg>
                        Editar
                    </button>
                    <!-- Visual buttons -->
                     <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold transition-all text-white h-10 px-4 bg-emerald-600 hover:bg-emerald-700 hover:shadow-md text-sm shadow-sm ring-1 ring-emerald-700/10">
                    ...
                    <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold transition-all border bg-white text-purple-700 border-purple-200 hover:bg-purple-50 hover:border-purple-300 h-10 px-4 text-sm shadow-sm">
                ...
                <div class="flex justify-end pt-3 border-t border-gray-200 mt-2">
                    <button type="button" data-modal-close class="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold transition-all border bg-white text-gray-700 hover:bg-gray-50 hover:text-red-600 hover:border-red-200 h-10 px-6 text-sm shadow-sm ring-1 ring-gray-200">
                        Cerrar
                    </button>
                </div>
            </div>
